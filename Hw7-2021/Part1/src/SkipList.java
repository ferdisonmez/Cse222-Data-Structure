...
public class SkipList<E extends Comparable<E>> implements NavigableSet<E> {
    ...
    /***
     * Descending defines an iterator
     * @return iterator
     */
    @Override
    ...
    private class Itr<E> implements Iterator<E> {
         Iterator iterator=Foriterator.descendingIterator();
        @Override
